...
//
//    @Severity(SeverityLevel.NORMAL)
//    @Story("story_id: 005  - Verify Field Mapping functionality of Training Screen in Templates ")
//    @Description("Verify Field Mapping functionlaity of Training Screen in Templates")
//    @Test(priority = 4, groups = "smoke", description = "Verify_Field_Mapping_functionlaity_of_Training_Screen_in_Templates")
...
//
//    @Severity(SeverityLevel.NORMAL)
//    @Story("story_id: 006  - verifyMandtoryFieldIsWorking")
//    @Description("verifyMandtoryFieldIsWorking")
//    @Test(priority = 5, groups = "smoke", description = "verifyMandtoryFieldIsWorking")
